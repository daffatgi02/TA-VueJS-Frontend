    ...
    <div>
      <div>
        ...
        <div class="bg-white rounded-lg py-4 px-6">
          <h3 slot="header" class="text-lg font-medium">Tambah Mahasiswa</h3>
          <form slot="body" class="py-4">
            <input class="border border-gray-400 p-2" v-model="nim" placeholder="NIM" />
            <input class="border border-gray-400 p-2" v-model="nama" placeholder="Nama" />
            <input class="border border-gray-400 p-2" v-model="email" placeholder="Email" />
          </form>
    ...
    <div id="profile" class="w-full rounded-lg shadow-2xl bg-white opacity-75 mx-6 lg:mx-20">
      <div class="p-4 md:p-12 text-center lg:text-left">
        ...
        <div class="mx-auto">
          ...
          <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full fixed right-30" @click="showModal = true">CREATE</button>
        </div>
      </div>
    </div>
