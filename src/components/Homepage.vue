<template>
    ...
    <body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://pmb.ittelkom-sby.ac.id/cdn/environment/background.jpg');">
        <div class="max-w-4xl flex items-center lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
            <div id="profile" class="w-full rounded-lg shadow-2xl bg-white opacity-75 mx-6 lg:mx-20">
                <div class="p-4 md:p-12 text-center lg:text-left">
                    <h1 class="text-3xl text-center font-bold pt-8 lg:pt-0">DATA MAHASISWA TEKNIK KOMPUTER</h1>
                    ...
                    <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><svg
                            class="h-4 fill-current text-red-700 pr-4" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20">
                            <path
                                d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z" />
                        </svg> INSTITUT TEKNOLOGI TELKOM SURABAYA</p>
                    <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                        <svg class="h-4 fill-current text-red-700 pr-4" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20">
                            <path
